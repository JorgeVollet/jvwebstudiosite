...
export const SEGMENTS: ArchiveSegment[] = [
  {
    ...
    icon: "workflow",
    cover: "/fluxos-n8n/agente-ia.webp",
    items: [
      {
        ...
        kind: "image",
        img: "/fluxos-n8n/criativos-ig.webp",
      },
      {
      ...
      },
      {
        ...
        kind: "image",
        img: "/fluxos-n8n/campanha-fria.webp",
      },
      {
        ...
        kind: "image",
        img: "/fluxos-n8n/google-places.webp",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        cover: "/briefings/ana-laura.webp",
      },
      {
    ...
    items: [
      {
        ...
        cover: "/saas/tech-01.webp?v=2",
        gallery: [
          "/saas/tech-01.webp?v=2",
          "/saas/tech-02.webp?v=2",
          "/saas/tech-03.webp?v=2",
          "/saas/tech-04.webp?v=2",
          "/saas/tech-05.webp?v=2",
        ],
      },
      {
        ...
        kind: "image",
        cover: "/saas/ana-01.webp?v=2",
        gallery: [
          "/saas/ana-01.webp?v=2",
          "/saas/ana-02.webp?v=2",
          "/saas/ana-03.webp?v=2",
          "/saas/ana-04.webp?v=2",
          "/saas/ana-05.webp?v=2",
          "/saas/ana-06.webp?v=2",
          "/saas/ana-07.webp?v=2",
          "/saas/ana-08.webp?v=2",
          "/saas/ana-09.webp?v=2",
          "/saas/ana-10.webp?v=2",
        ],
      },
      {

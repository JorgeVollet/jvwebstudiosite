 ...
 *
 * Carregamento simples e direto (como na 1a versão, que rodava suave):
 * o script é injetado no mount e a animação inicia. Sem requestIdleCallback
 * e sem content-visibility — ambos causavam engasgo no canvas WebGL.
 */

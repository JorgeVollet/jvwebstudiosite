  ...
  return (
    <section id="top" className="section-dark relative flex min-h-screen items-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pt-32 pb-20 md:px-10">
        ...
        {/* Selo da oferta risco-zero */}
        <div className="mt-8 inline-flex items-center gap-2.5 rounded-full border border-gold-3/40 bg-gold-3/10 px-4 py-2 backdrop-blur-md">
          <span className="font-display text-sm font-bold text-gold-metal">Demonstração grátis</span>
          <span className="h-3 w-px bg-gold-3/40" />
          <span className="text-xs text-neutral-300">você só paga se aprovar o site pronto</span>
        </div>

        <div className="mt-7 flex flex-wrap items-center gap-4">
          <a href="#briefing" className="btn-gold px-8 py-4 text-sm uppercase tracking-widest">
            Quero minha demonstração
          </a>
          <a href="#oferta" className="btn-outline-gold px-8 py-4 text-sm uppercase tracking-widest">
            Como funciona
          </a>
        </div>
